...
public class PutUserRequest extends Request {
	private static final String TAG  = "PutUserRequest";
	
	private String server;
	private User user;
	
	public PutUserRequest(String server,User user){
	...
	public Response doInBackground() {
		...
		if((HttpStatus.SC_OK == status)
			...
			//リクエスト成功
			try {
		        resp = new PutUserResponse(Response.STATUS_SUCCESS,status,outputStream.toString());
		    } catch (Exception e) {
		        Log.e(TAG, "Error");
		    }
		}else{
